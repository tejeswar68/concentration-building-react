  ...
  return (
    <div className='container'>
      ...
      <img src={img1} className="mx-auto d-block med"alt="Not found" style={{width:"80%"}}></img>  
       ...
       <div className='row'>
              <div className='col-sm-6 p-5 box1'>
              ...
              <div className='col-sm-6 p-5 box2'>
       ...
       <div className='row '>
       <div className='col-sm-6 p-5 box3'>
       ...
       <div className='col-sm-6 p-5 box4'>
       ...
       <div className='row '>
       <div className='col-sm-6 p-5 box5'>
       ...
       <div className='col-sm-6 p-5 box6'>
       ...
       <img src={img7} className="mx-auto d-block"alt="Not found" style={{width:"50%"}}></img>  
          ...
          <h1 className='text-center text-light m-5'>MELODY</h1>
          <div className='songs'>
